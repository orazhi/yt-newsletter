...
# ---------------------------------------------------------------------------
# AI / engineering frontier — your skill-compounding engine. TLDR sec plus the
# primary sources the big newsletters themselves summarize (arXiv, Hacker News).
# The Batch, Data Elixir and the IBM Research blog are gated/blocked for cloud
# runners (Cloudflare / captcha / dead endpoint); you're subscribed to the first
# two and read them by email, and IBM is covered by @IBMTechnology in the
# watchlist — so none of them are fetched here.
# ---------------------------------------------------------------------------
_AI: list[Source] = [
    Source("TLDR sec", "ai", "rss", "https://tldrsec.com/feed.xml"),
...
# ---------------------------------------------------------------------------
_NEWS: list[Source] = [
    Source("The News Minute", "news", "rss", "https://www.thenewsminute.com/feed"),
    Source("Scroll.in", "news", "rss", "https://scroll.in/feed"),  # (verify)
    # deKoder's RSS endpoint 500s; covered by @DeKoderAI in the watchlist.
...
# ---------------------------------------------------------------------------
_MONEY: list[Source] = [
    # warikoo's Substack blocks cloud-runner IPs (403); covered by @warikoo below.
